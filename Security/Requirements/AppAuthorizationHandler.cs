...
namespace AppRazor.Security.Requirements
{
    public class AppAuthorizationHandler : IAuthorizationHandler
    {
        ...
        public Task HandleAsync (AuthorizationHandlerContext context){
            ...
            foreach (var requirement in requirements)
            {
                ...
                {
                    if (InGenZ(context.User, (GenZRequirement)requirement))
                    {
                        context.Succeed(requirement);
                    }
                    // xử lý kiểm tra User đảm bảo requirement/GenZRequirement
                    //context.Succeed(requirement);
                }
        ...
        private bool InGenZ(ClaimsPrincipal user, GenZRequirement requirement)
        {
